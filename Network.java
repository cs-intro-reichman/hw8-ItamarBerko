    ...
    *  Otherwise, creates a new user with the given name, adds the user to this network, and returns true. */
    ...
    public String recommendWhoToFollow(String name) {
        ...
        for (int i = 0; i < this.userCount; i++){
            ...
            int mutual = oUser.countMutual(this.users[i]);
            if (mutual > maxMutual) {
    ...
    public String mostPopularUser() {
        ...
        int maxAppearence = 0;
        for (int i = 0; i < this.userCount; i++){
            int appearences = this.followeeCount(this.users[i].getName());
            if (appearences > maxAppearence){
                mostPoplarUser = this.users[i];
                maxAppearence = appearences;
            }
        }
        return mostPoplarUser.getName();
    }
